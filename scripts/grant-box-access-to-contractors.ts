 ...
 *
 * 使い方:
 * npx ts-node scripts/grant-box-access-to-contractors.ts
 */

import { createClient } from '@supabase/supabase-js'
import { findOrCreateBoxUser, addFolderCollaboration } from '../src/lib/box-collaboration'
import { getBoxFolderItems } from '../src/lib/box'
