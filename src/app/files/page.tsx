...
export default function FilesPage() {
  ...
  // Mock file data with Box API integration simulation
  const files = [
    {
      id: "1",
      ...
      checkOutBy: "田中太郎",
      previewUrl: "/preview/road-design.jpg",
      downloadCount: 12,
    ...
    },
    {
      ...
      checkOutBy: null,
      previewUrl: "/preview/bridge-report.jpg",
      downloadCount: 5,
      lastAccessed: "2024-01-18T09:20:00Z",
      metadata: {
        document_type: "点検報告書",
    ...
    },
    {
      ...
      checkInStatus: "checked_in",
      checkOutBy: null,
      previewUrl: "/preview/geological-data.jpg",
      downloadCount: 8,
      lastAccessed: "2024-01-17T16:30:00Z",
      metadata: {
        data_type: "地質調査",
    ...
    },
    {
      ...
      checkOutBy: "監督員",
      previewUrl: "/preview/construction-plan.jpg",
      downloadCount: 25,
      lastAccessed: "2024-01-18T13:10:00Z",
      metadata: {
        document_type: "施工計画書",
